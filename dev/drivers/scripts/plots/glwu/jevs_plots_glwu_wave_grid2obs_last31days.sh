...
<<<<<<< HEAD:dev/drivers/scripts/plots/glwu/jevs_glwu_wave_grid2obs_plots.sh
=======
export EVAL_PERIOD="last31days"
>>>>>>> develop:dev/drivers/scripts/plots/glwu/jevs_plots_glwu_wave_grid2obs_last31days.sh
